...
/*mango de taza*/
loader.load('public/mango.jpg', function(texture){
    let geometry = new THREE.CubeGeometry(2, 0.3, 1, 5, 1, false)
    let material = new THREE.MeshBasicMaterial({
        map: texture
    })
...
loader.load('public/mango.jpg', function(texture){
    let geometry = new THREE.CubeGeometry(0.3, 2.3, 1, 5, 1, false)
    let material = new THREE.MeshBasicMaterial({
        map: texture
    })
...
loader.load('public/mango.jpg', function(texture){
    let geometry = new THREE.CubeGeometry(3, 0.3, 1, 5, 1, false)
    let material = new THREE.MeshBasicMaterial({
        map: texture
    })
    ...
    mesh.position.y = 10;
    mesh.position.x = 45.1;
    mesh.castShadow = true;
    scene.add(mesh);
})
loader.load('public/mango.jpg', function(texture){
    let geometry = new THREE.CubeGeometry(0.3, 2, 1, 5, 1, false)
    let material = new THREE.MeshBasicMaterial({
        map: texture
    })
...
loader.load('public/mango.jpg', function(texture){
    ...
    mesh.position.y = 12;
    mesh.position.x = 30.2;
    mesh.position.z = 25;
    mesh.castShadow = true;
    scene.add(mesh);
})
loader.load('public/mango.jpg', function(texture){
    let geometry = new THREE.CubeGeometry(2.4, 0.3, 1, 5, 1, false)
    let material = new THREE.MeshBasicMaterial({
        map: texture
    })
